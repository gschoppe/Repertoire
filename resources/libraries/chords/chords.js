...
var chords = (function(){
    ...
    // define common first position guitar chords
    // Majors, Minors, & 7ths done
    var DEFAULTCHORDS = {
        Ab  :{positions:'466544', fingers:'134211'},
        Ab7 :{positions:'XX1112', fingers:'--1112'},
        Abm :{positions:'466444', fingers:'134111'},
        Abm :{positions:'464444', fingers:'131111'},
        A   :{positions:'X02220', fingers:'--213-'},
        A7  :{positions:'X02020', fingers:'--2-3-'},
        Am  :{positions:'X02210', fingers:'--231-'},
        Am7 :{positions:'X02010', fingers:'--2-1-'},
        Bb  :{positions:'X13331', fingers:'-12341'},
        Bb7 :{positions:'X13231', fingers:'-13241'},
        Bbm :{positions:'X13321', fingers:'-13421'},
        Bbm7:{positions:'XX3324', fingers:'--2314'},
        B   :{positions:'X24442', fingers:'-12341'},
        B7  :{positions:'X21202', fingers:'-213-4'},
        Bm  :{positions:'X24432', fingers:'-13421'},
        Bm7 :{positions:'X20202', fingers:'-2-3-4'},
        C   :{positions:'X32010', fingers:'-32-1-'},
        C7  :{positions:'032310', fingers:'-3241-'},
        Cm  :{positions:'X35543', fingers:'-13421'},
        Cm7 :{positions:'X35343', fingers:'-13121'},
        Db  :{positions:'043121', fingers:'-43121'},
        Db7 :{positions:'X4342X', fingers:'-3241-'},
        Dbm :{positions:'X35543', fingers:'-13421'},
        Dbm7:{positions:'X42400', fingers:'-314--'},
        D   :{positions:'XX0232', fingers:'---132'},
        D7  :{positions:'XX0212', fingers:'---213'},
        Dm  :{positions:'XX0231', fingers:'---231'},
        Dm7 :{positions:'X00211', fingers:'---211'},
        Eb  :{positions:'XX1343', fingers:'--1243'},
        Eb7 :{positions:'XX1323', fingers:'--1324'},
        Ebm :{positions:'X11342', fingers:'-11342'},
        Ebm7:{positions:'X11342', fingers:'-11342'},
        E   :{positions:'022100', fingers:'-231--'},
        E7  :{positions:'020100', fingers:'-2-1--'},
        Em  :{positions:'022000', fingers:'-21---'},
        Em7 :{positions:'020000', fingers:'-2----'},
        F   :{positions:'133211', fingers:'134211'},
        F7  :{positions:'xx3241', fingers:'--3241'},
        Fm  :{positions:'133111', fingers:'134111'},
        Fm7 :{positions:'XX1111', fingers:'--1111'},
        Gb  :{positions:'244322', fingers:'134211'},
        Gb7 :{positions:'242322', fingers:'131211'},
        Gbm :{positions:'244222', fingers:'134111'},
        Gbm7:{positions:'242222', fingers:'131111'},
        G   :{positions:'320003', fingers:'32---4'},
        G7  :{positions:'320001', fingers:'32---1'},
        Gm  :{positions:'355333', fingers:'134111'},
        Gm7 :{positions:'353333', fingers:'131111'},
    };
    
    var GetDefaultChord = function(name) {
        name = name.replace(/^A#/,"Bb");
        name = name.replace(/^C#/,"Db");
        name = name.replace(/^D#/,"Eb");
        name = name.replace(/^F#/,"Gb");
        name = name.replace(/^G#/,"Ab");
        return DEFAULTCHORDS[name];
    }
    ...
    var ReplaceChordElements = function() {
        $('chord').each(function(i, elt){
            ...
            if(!positions || positions == null || typeof positions === 'undefined') {
                chordDef  = GetDefaultChord(name);
                positions = chordDef['positions'];
                fingers   = chordDef['fingers'  ];
            }
